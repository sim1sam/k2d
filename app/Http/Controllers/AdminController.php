...
class AdminController extends Controller
{
    ...
    public function admin_dashboard(Request $request)
    {
        ...
        $data['total_reqorders'] = Reqorder::count();
        $data['processing_reqorders'] = Reqorder::where('status', 'processing')->count();
        $data['shipfromkol_reqorders'] = Reqorder::where('status', 'shipfromkol')->count();
        $data['shipfromdhk_reqorders'] = Reqorder::where('status', 'shipfromdhk')->count();
        $data['completed_reqorders'] = Reqorder::where('status', 'completed')->count();
        $data['canceled_reqorders'] = Reqorder::where('status', 'canceled')->count();
