...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'status','password', 'address', 'city', 'postal_code', 'phone', 'country', 'provider_id', 'email_verified_at', 'verification_code', 'dob','fb_id_link','dress_size','shoe_size'
    ];
    ...
    {
        return $this->hasMany(ReqOrderItem::class, 'user_id');
    }
   // public function reqorders()
   // {
     //   return $this->hasMany(ReqOrder::class, 'customer_id');
    //}
    // In User.php model
    public function reqorders()
    {
        return $this->hasMany(ReqOrder::class, 'user_id'); // Use 'user_id' instead of 'customer_id'
    }
