...
<html lang="en">
	...
	<body class="bg-secondary">
		...
		<div class="container<?php if ( ! isset( $_SESSION['active'] ) ) { ?> my-5 py-5<?php } ?>">
			<div class="row">
				<div class="col-md-12">
					<?php
						// ilovek2d
												...
												<table class="table table-striped w-100 border">
													<tr>
														<th colspan="2" class="p-0">
															<h4 class="mb-0 py-3 px-2 bg-warning text-center">RS to BDT Pricing</h4>
														</th>
													</tr>
													<?php if ( 2 + 2 == 5) { ?>
													<tr>
