    ...
    @can('admin_dashboard')
        <div class="row gutters-16">
            <div class="bg-light p-3 rounded">
                <!-- Title -->
                <h5 class="text-center text-dark mb-3">Request Order</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3">
                        <div class="card bg-primary text-white h-100">
                            <div class="card-body text-center">
                                <h6 class="card-title mb-1">All Orders</h6>
                                <p class="card-text fw-bold fs-4">{{$total_reqorders}}</p> <!-- Bold and big text -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 mb-3">
                        <div class="card bg-warning text-white h-100">
                            <div class="card-body text-center">
                                <h6 class="card-title mb-1">Processing</h6>
                                <p class="card-text fw-bold fs-4">{{$processing_reqorders}}</p> <!-- Bold and big text -->
                            </div>
                        </div>
                    </div>

                    <!-- Ship From Kolkata Orders Card -->
                    <div class="col-md-2 mb-3">
                        <div class="card bg-info text-white h-100">
                            <div class="card-body text-center">
                                <h6 class="card-title mb-1">Ship From Kolkata</h6>
                                <p class="card-text fw-bold fs-4">{{$shipfromkol_reqorders}}</p> <!-- Bold and big text -->
                            </div>
                        </div>
                    </div>

                    <!-- Ship From Dhaka Orders Card -->
                    <div class="col-md-2 mb-3">
                        <div class="card bg-success text-white h-100">
                            <div class="card-body text-center">
                                <h6 class="card-title mb-1">Ship From Dhaka</h6>
                                <p class="card-text fw-bold fs-4">{{$shipfromdhk_reqorders}}</p> <!-- Bold and big text -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 mb-3">
                        <div class="card bg-success text-white h-100">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text fw-bold fs-4">{{$completed_reqorders}}</p> <!-- Bold and big text -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 mb-3">
                        <div class="card bg-danger text-white h-100">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text fw-bold fs-4">{{$canceled_reqorders}}</p> <!-- Bold and big text -->
                            </div>
                        </div>
                    </div>
                </div>
