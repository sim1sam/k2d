    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <!-- Banks -->
@canany(['view_banks', 'add_bank'])
<li class="aiz-side-nav-item">
    <a href="#" class="aiz-side-nav-link">
        <div class="aiz-side-nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                <path d="M12 2L2 7v2h20V7l-10-5zm-1 12H5v3h6v-3zm8 0h-6v3h6v-3zm-8-5H5v3h6V9zm8 0h-6v3h6V9zm-9 10H5v3h6v-3zm8 0h-6v3h6v-3z"/>
            </svg>
        </div>
    ...
    <ul class="aiz-side-nav-list level-2">
        @can('add_bank')
            <li class="aiz-side-nav-item">
                <a class="aiz-side-nav-link" href="{{route('backend.banks.create')}}">
                    <span class="aiz-side-nav-text">{{translate('Add New Bank')}}</span>
                </a>
            </li>
        @endcan
        @can('view_banks')
            <li class="aiz-side-nav-item">
                <a class="aiz-side-nav-link" href="{{route('backend.banks.index')}}">
                    <span class="aiz-side-nav-text">{{translate('Bank List')}}</span>
                </a>
            </li>
        @endcan
    </ul>
...
@canany(['view_feedback', 'add_feedback'])
<li class="aiz-side-nav-item">
    <a href="#" class="aiz-side-nav-link">
        <div class="aiz-side-nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
    ...
    <ul class="aiz-side-nav-list level-2">
        {{-- @can('add_feedback')
            <li class="aiz-side-nav-item">
                <a class="aiz-side-nav-link" href="{{ route('admin.feedbacks.create') }}">
                    <span class="aiz-side-nav-text">{{translate('Add New Feedback')}}</span>
                </a>
            </li>
        @endcan --}}
        @can('view_feedback')
            <li class="aiz-side-nav-item">
                <a class="aiz-side-nav-link" href="{{ route('admin.feedbacks.index') }}">
                    <span class="aiz-side-nav-text">{{translate('Feedback List')}}</span>
                </a>
            </li>
        @endcan
    </ul>
...
@endcanany
            ...
            <!-- Accounts -->
                @canany(['view_cashin', 'view_cashout'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_cashin')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{route('backend.cashIn.index')}}">
                                        <span class="aiz-side-nav-text">{{translate('Cash In')}}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_cashout')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{route('backend.cashOut.index')}}">
                                        <span class="aiz-side-nav-text">{{translate('Cash Out')}}</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
...
<!-- Shipments -->
@canany(['view_shipments', 'add_shipment','shipments_report'])
<li class="aiz-side-nav-item">
    <a href="#" class="aiz-side-nav-link">
        <div class="aiz-side-nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
    ...
    <ul class="aiz-side-nav-list level-2">
        @can('add_shipment')
            <li class="aiz-side-nav-item">
                <a class="aiz-side-nav-link" href="{{route('backend.shipments.create')}}">
                    <span class="aiz-side-nav-text">{{translate('Add New Shipment')}}</span>
                </a>
            </li>
        @endcan
        @can('view_shipments')
            <li class="aiz-side-nav-item">
                <a class="aiz-side-nav-link" href="{{route('backend.shipments.index')}}">
                    <span class="aiz-side-nav-text">{{translate('Shipment List')}}</span>
                </a>
            </li>
        @endcan
            @can('shipments_report')
                <li class="aiz-side-nav-item">
                    <a class="aiz-side-nav-link" href="{{route('backend.shipments.report')}}">
                        <span class="aiz-side-nav-text">{{translate('Shipment Report')}}</span>
                    </a>
                </li>
            @endcan
    </ul>
...
@endcanany
            ...
            <!-- Offer -->
                @canany(['view_offers', 'add_offer','select_customer'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Offer')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!-- Submenu -->
                        <ul class="aiz-side-nav-list level-2">
                            @can('add_offer')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{route('backend.offers.create')}}">
                                        <span class="aiz-side-nav-text">{{translate('Add Offer')}}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_offers')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{route('backend.offers.index')}}">
                                        <span class="aiz-side-nav-text">{{translate('View Offer')}}</span>
                                    </a>
                                </li>
                            @endcan
                                @can('select_customer')
                                    <li class="aiz-side-nav-item">
                                        <a class="aiz-side-nav-link" href="{{ route('offers.select-customers') }}">
                                        <span class="aiz-side-nav-text">{{translate('Select Customer')}}</span>
                                        </a>
                                    </li>
                                @endcan
                        </ul>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @endcan
                            ...
                            @can('view_all_req_orders')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('backend.req.order.index') }}"
                                       class="aiz-side-nav-link {{ areActiveRoutes(['backend.req.order.index', 'backend.req.order.show', 'backend.req.order.edit', 'backend.req.order.destroy']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Request Orders') }}</span>
                                    </a>
                                </li>
                            @endcan
            ...
            <!-- Gallery -->
                @canany(['view_gallery', 'add_gallery'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @can('add_gallery')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{route('backend.gallery.create')}}">
                            ...
                            @can('view_gallery')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{route('backend.gallery.index')}}">
                                        <span class="aiz-side-nav-text">{{translate('Album List')}}</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @can('brand & vendor order_report')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('report-reqorder.create') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Brand & Vendor Wise Req Report') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('earning_report')
