...
<div>
    ...
    <div style="margin-top: 20px; margin-left: 20px; margin-right: 20px;">
        <h3 style="font-size: 14px; margin-bottom: 10px; font-weight: bold; border-bottom: 2px solid #333; padding-bottom: 5px;">{{ translate('Payment Breakdown') }}</h3>
        <table style="width: 100%; border-collapse: collapse; border: 1px solid #ddd;">
            <thead>
                <tr style="background-color: #f8f8f8;">
                    <th style="width: 25%; padding: 8px; text-align: left; border-bottom: 1px solid #ddd;">{{ translate('Date') }}</th>
                    <th style="width: 25%; padding: 8px; text-align: left; border-bottom: 1px solid #ddd;">{{ translate('Payment Method') }}</th>
                    <th style="width: 25%; padding: 8px; text-align: left; border-bottom: 1px solid #ddd;">{{ translate('Status') }}</th>
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td style="text-align: right; padding: 8px; border-top: 1px solid #ddd; font-weight: bold;">BDT {{ number_format(max(0, $reqorder->due), 2) }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
