...
<div class="p-4 text-center mb-4 border-bottom position-relative">
    ...
    <!-- Status Badge -->
    <div class="d-inline-block px-3 py-1 rounded-pill bg-primary text-white fs-12 fw-600">
        {{ $user->status }}
    </div>

    <!-- Phone -->
    @if ($user->phone != null)
        <div class="text-truncate opacity-60 fs-12 mt-1">{{ $user->phone }}</div>
    <!-- Email -->
    @else
        <div class="text-truncate opacity-60 fs-12 mt-1">{{ $user->email }}</div>
    @endif
</div>
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                @endphp
                      ...
                      <!-- Create Order -->
        <li class="aiz-side-nav-item">
            <a href="{{ route('frontend.order.create') }}"
               class="aiz-side-nav-link {{ areActiveRoutes(['frontend.order.create']) }}">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#b5b5bf" class="bi bi-cart" viewBox="0 0 16 16">
                <path d="M0 1a1 1 0 0 1 1-1h2.5a1 1 0 0 1 .96.735L4.89 3H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 10H5.18l-.342 1.342A1 1 0 0 0 5.82 13H13.5a.5.5 0 0 1 0 1H5.82a2 2 0 0 1-1.94-1.515L3.22 10H1a.5.5 0 0 1 0-1h1.22l1.5-6A1 1 0 0 1 4.5 2H1a1 1 0 0 1-1-1zM5.5 13a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 1a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
            </svg>
                <span class="aiz-side-nav-text ml-3">{{ translate('Create Pre-Order') }}</span>
            </a>
        </li>

        <!-- Req Orders Menu Item -->
        <li class="aiz-side-nav-item">
            <a href="{{ route('frontend.order.index') }}"
               class="aiz-side-nav-link {{ areActiveRoutes(['frontend.order.index']) }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#b5b5bf" class="bi bi-card-list" viewBox="0 0 16 16">
                    <path d="M2 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5m0 4a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5m0 4a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5"/>
                    <path d="M4 5.5a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0m0 4a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0m0 4a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0"/>
                </svg>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('purchase_history.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Website Orders') }}</span>
                ...
                <!-- Offer -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('frontend.offer.index') }}"
                       class="aiz-side-nav-link {{ areActiveRoutes(['frontend.offer.index']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#b5b5bf" class="bi bi-gift" viewBox="0 0 16 16">
                            <path d="M8 0C7.469 0 7 .469 7 1V3H5.5a1 1 0 0 0-1 1v1.5h-1a1 1 0 0 0-1 1V7h3.5a1 1 0 0 1 1 1V9h4V8a1 1 0 0 0-1-1H13V6.5a1 1 0 0 0-1-1H9V1c0-.531-.469-1-1-1zM8 1v2h4V1H8zM1 7h1v3h1V7H1zM13 7h1v3h-1V7zM5.5 8H4V7h1.5V8zM8 12c1.105 0 2 .895 2 2s-.895 2-2 2-2-.895-2-2 .895-2 2-2z"/>
                        </svg>
                        <span class="aiz-side-nav-text ml-3">{{ translate('Active Offer') }}</span>
                    </a>
                </li>
               ...
               <!-- <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('support_ticket.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Need Shipment Summary') }}</span>
                        @if ($support_ticket > 0)
