        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="px-4 bg-white border h-100">
                ...
                <div class="d-flex align-items-center py-4 border-bottom">
                    ...
                    <div class="ml-3 d-flex flex-column justify-content-between">
                        @php
                            // Fetch the request orders count (you can modify the condition based on your requirements)
                            $reqordersCount = auth()->user()->reqOrders->count();  // assuming the user has a relationship with ReqOrder
                        @endphp
                        <span class="fs-20 fw-700 mb-1">{{ $reqordersCount > 0 ? sprintf("%02d", $reqordersCount) : 0 }}</span>
                        <span class="fs-14 fw-400 text-secondary">{{ translate('Request Order') }}</span>
                    </div>
