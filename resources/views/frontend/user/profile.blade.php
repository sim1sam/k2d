...
<!-- Date of Birth (dob)-->
<div class="form-group row">
    <label class="col-md-2 col-form-label fs-14">{{ translate('Date of Birth') }}</label>
    <div class="col-md-10">
        <input type="date" class="form-control rounded-0" name="dob" value="{{ Auth::user()->dob }}">
    </div>
</div>

<!-- Facebook ID Link (fb_id_link)-->
<div class="form-group row">
    <label class="col-md-2 col-form-label fs-14">{{ translate('Facebook ID Link') }}</label>
    <div class="col-md-10">
        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Facebook ID Link') }}" name="fb_id_link" value="{{ Auth::user()->fb_id_link }}">
    </div>
</div>

<!-- Dress Size-->
<div class="form-group row">
    <label class="col-md-2 col-form-label fs-14">{{ translate('Dress Size') }}</label>
    <div class="col-md-10">
        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Dress Size') }}" name="dress_size" value="{{ Auth::user()->dress_size }}">
    </div>
</div>

<!-- Shoe Size-->
<div class="form-group row">
    <label class="col-md-2 col-form-label fs-14">{{ translate('Shoe Size') }}</label>
    <div class="col-md-10">
        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Shoe Size') }}" name="shoe_size" value="{{ Auth::user()->shoe_size }}">
    </div>
</div>

  <!-- facebook page review screenshot-->
  <div class="form-group row">
    <label class="col-md-2 col-form-label fs-14">{{ translate('Facebook Page Review Screenshot') }}</label>
    <div class="col-md-10">
        <div class="input-group" data-toggle="aizuploader" data-type="image">
            <div class="input-group-prepend">
                <div class="input-group-text bg-soft-secondary font-weight-medium rounded-0">{{ translate('Browse')}}</div>
            ...
            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
            <input type="hidden" name="fb_review_screenshot" value="{{ Auth::user()->fb_review_screenshot }}" class="selected-files">
        </div>
        <div class="file-preview box sm">
        </div>
    </div>
