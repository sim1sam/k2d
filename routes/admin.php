...
use App\Http\Controllers\AdminReqOrderController;
...
use App\Http\Controllers\ShipmentProductDetailController;
...
Route::get('/feedbacks', [FeedbackController::class, 'adminFeedbacks'])->name('admin.feedbacks.index');
    ...
    // Bank
    Route::resource('banks', BankController::class)->names('backend.banks');

    //shipment

    Route::prefix('shipments')->middleware(['auth', 'admin'])->name('backend.shipments.')->group(function () {
        // Show the list of shipments
        Route::get('/', [ShipmentController::class, 'index'])->name('index');

        // Show the create form for a new shipment
        Route::get('/create', [ShipmentController::class, 'create'])->name('create');

        // Store the new shipment
        Route::post('/', [ShipmentController::class, 'store'])->name('store');

        // Show the edit form for a shipment
        ...
        Route::get('shipments/{shipment}/attach', [ShipmentController::class, 'attach'])->name('attach');


        Route::get('shipment-report', [ShipmentController::class, 'reportindex'])->name('report');

        Route::get('/{shipment}/{customer}/invoice', [ShipmentController::class, 'generateInvoice'])->name('invoice');
    ...
    // Offer
    Route::resource('offers', OfferController::class)->names('backend.offers');
    Route::get('backend/offers/select-customers', [OfferController::class, 'showOffersAndCustomers'])->name('offers.select-customers');
    Route::post('offers/attach-customers', [OfferController::class, 'attachCustomers'])->name('offers.attach-customers');
    Route::post('offers/remove-customer', [OfferController::class, 'removeCustomer'])->name('offers.remove-customer');
    // Gallery
    Route::resource('gallery', GalleryController::class)->names('backend.gallery');

    // Req Order
    Route::get('request-orders/create', [AdminReqOrderController::class, 'create'])->name('backend.req.order.create');
    Route::post('request-orders/store', [AdminReqOrderController::class, 'store'])->name('backend.req.order.store');
    Route::get('request-orders', [AdminReqOrderController::class, 'index'])->name('backend.req.order.index');
    Route::get('request-order/edit/{id}', [AdminReqOrderController::class, 'edit'])->name('backend.req.order.edit');
    Route::put('/request-order/update/{id}', [AdminReqOrderController::class, 'update'])
    ->name('backend.req.order.update');
    Route::get('req/orders/{order}', [AdminReqOrderController::class, 'show'])->name('backend.req.order.show');

    Route::get('request-order/delete', [AdminReqOrderController::class, 'delete'])->name('backend.req.order.destroy');
    Route::put('/req-order/{id}/update-status', [AdminReqOrderController::class, 'updateOrderStatus'])->name('backend.req.order.update_status');
    Route::get('/req-order/{id}/address', [AdminReqOrderController::class, 'updateAddress'])->name('backend.req.order.address.edit');
    Route::put('/req-order-item/{id}/update-status', [AdminReqOrderController::class, 'updateOrderItemStatus'])->name('backend.req.order_item.update_status');
    Route::delete('req-order/item/{id}', [AdminReqOrderController::class, 'destroyItem'])->name('backend.req.order_item.destroy');
    Route::put('/backend/orders/{order}/update-address', [AdminReqOrderController::class, 'uupdateAddress'])->name('backend.req.orders.update');
    Route::post('/request-orders/payment', [AdminReqOrderController::class, 'adminMakePayment'])->name('admin.order.payment');
    Route::get('/req-orders/invoice/download/{order_id}/{item_id?}', [AdminReqOrderController::class, 'downloadInvoice'])->name('admin.req-orders.invoice.download');
    Route::post('/req-order/{id}/discount', [AdminReqOrderController::class, 'applyDiscount'])->name('backend.req.order_item.discount');
    Route::get('/req-order/brand-vendor/filter', [AdminReqOrderController::class, 'filterCreate'])->name('report-reqorder.create');



    // Accounts cash in
    Route::get('/cash-in', [AccountController::class, 'showCashInForm'])->name('backend.cashInCreate');
    Route::get('/cash-in/list', [AccountController::class, 'CashInindex'])->name('backend.cashIn.index');
    Route::post('/cash-in/', [AccountController::class, 'CashIn'])->name('backend.cashIn');
    Route::get('/cash-in/{id}', [AccountController::class, 'show'])->name('backend.cashInView');
    Route::get('/cash-in/edit/{id}', [AccountController::class, 'edit'])->name('backend.cashInEdit');
    Route::put('/cash-in/update/{id}', [AccountController::class, 'update'])->name('backend.cashIn.update');
    Route::delete('/cash-in/delete/{id}', [AccountController::class, 'destroy'])->name('backend.cashInDelete');

    // Cash Out Routes
    Route::get('/cash-out', [AccountController::class, 'indexCashOut'])->name('backend.cashOut.index'); // Index Page
    Route::get('/cash-out/create', [AccountController::class, 'createCashOut'])->name('backend.cashOutCreate'); // Create Form
    Route::post('/cash-out/store', [AccountController::class, 'storeCashOut'])->name('backend.cashOut'); // Store Data
    Route::get('/cash-out/{id}', [AccountController::class, 'showCashOut'])->name('backend.cashOutView'); // Show Details
    Route::get('/cash-out/{id}/edit', [AccountController::class, 'editCashOut'])->name('backend.cashOutEdit'); // Edit Form
    Route::put('/cash-out/{id}', [AccountController::class, 'updateCashOut'])->name('backend.cashOutUpdate'); // Update Data
    Route::delete('/cash-out/{id}', [AccountController::class, 'deleteCashOut'])->name('backend.cashOutDelete'); // Delete Record

    Route::get('/cashin/invoice/download/{id}', [AccountController::class, 'downloadCashInInvoice'])->name('cashin.invoice.download');
    Route::get('/cashout/invoice/download/{id}', [AccountController::class, 'downloadCashOutInvoice'])->name('cashout.invoice.download');



    Route::prefix('shipment')->name('backend.shipment.')->group(function () {
        Route::post('/store/{id}', [ShipmentProductDetailController::class, 'store'])->name('store');
        Route::get('/export/{id}', [ShipmentProductDetailController::class, 'export'])->name('export');
    });
    ...
    Route::put('/customers/{id}/status', [CustomerController::class, 'updateUserStatus'])->name('backend.users.updateStatus');
//transaction
    Route::get('/transactions/{id}', [AccountController::class, 'Transindex'])->name('transactions.index');
