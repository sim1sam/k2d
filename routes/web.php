...
use App\Http\Controllers\ReqOrderController;
...
Route::get('/feedback', [FeedbackController::class, 'feedbackForm'])->name('feedback-form');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::controller(HomeController::class)->group(function () {
        Route::resource('req-order', ReqOrderController::class)->names('frontend.order');
        Route::get('req-order', [ReqOrderController::class, 'index'])->name('frontend.order.index');
        Route::get('req-order', [ReqOrderController::class, 'show'])->name('frontend.order.show');
        Route::get('/order/payment/form/{encryptedItemId}', [ReqOrderController::class, 'showPaymentForm'])->name('order.payment.form');
        Route::post('/order/payment', [ReqOrderController::class, 'makePayment'])->name('order.payment');

        Route::get('/req-checkout', [ReqOrderController::class, 'checkout'])->name('frontend.req.checkout');
        Route::post('checkout/update-address', [ReqOrderController::class, 'updateAddress'])->name('frontend.req.checkout.updateAddress');
        Route::post('/req-checkout/confirm', [ReqOrderController::class, 'confirmOrder'])->name('frontend.req.checkout.confirm');
        Route::get('/invoice/{reqorder_id}/download', [ReqOrderController::class, 'downloadInvoice'])->name('invoices.download');

        Route::get('/offers', [OfferController::class, 'CustomerOfferIndex'])->name('frontend.offer.index');
        Route::get('/offer/{id}', [OfferController::class, 'CustomerOffershow'])->name('frontend.offer.show');
